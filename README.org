...
The project license is in [[file:LICENSE][LICENSE]] (GNU GPL). The fzf code uses
the MIT license in [[file:LICENSE-MIT][LICENSE-MIT]]. The SIMD prefilters use ideas
from Frizbee and memchr under the same license. Vendored utf8proc and Unicode
data notices are in [[file:utf8proc-2.10.0/LICENSE.md][utf8proc-2.10.0/LICENSE.md]]
