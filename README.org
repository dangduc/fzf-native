...
The selected scheme is part of the session request identity and both cache identities.
Thus, one query can keep separate cached rankings for different schemes.
