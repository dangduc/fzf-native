...
FZF_REFERENCE_GO_TOOLCHAIN ?=
FZF_REFERENCE_UNICODE_VERSION ?=
FZF_NATIVE_UNICODE_LIBRARY ?=
FZF_NATIVE_UNICODE_LIBRARY_VERSION ?=
FZF_NATIVE_UNICODE_VERSION ?=
FZF_SOURCE ?=
...
fuzz-upstream: fuzz-module
	...
	FZF_NATIVE_TEST_MODULE=$(FUZZ_MODULE) FZF_REFERENCE=$(FZF_REFERENCE) \
		...
		FZF_REFERENCE_GO_TOOLCHAIN=$(FZF_REFERENCE_GO_TOOLCHAIN) \
		FZF_REFERENCE_UNICODE_VERSION=$(FZF_REFERENCE_UNICODE_VERSION) \
		FZF_NATIVE_UNICODE_LIBRARY=$(FZF_NATIVE_UNICODE_LIBRARY) \
		FZF_NATIVE_UNICODE_LIBRARY_VERSION=$(FZF_NATIVE_UNICODE_LIBRARY_VERSION) \
		FZF_NATIVE_UNICODE_VERSION=$(FZF_NATIVE_UNICODE_VERSION) \
		FZF_NATIVE_FUZZ_SEED=$(FZF_NATIVE_FUZZ_SEED) \
...
fuzz-upstream-pinned: fuzz-module fuzz-pinned-fzf-build
	FZF_NATIVE_TEST_MODULE=$(FUZZ_MODULE) \
		...
		FZF_REFERENCE_GO_TOOLCHAIN=go1.27.1 \
		FZF_REFERENCE_UNICODE_VERSION=17.0.0 \
		FZF_NATIVE_UNICODE_LIBRARY=utf8proc \
		FZF_NATIVE_UNICODE_LIBRARY_VERSION=2.10.0 \
		FZF_NATIVE_UNICODE_VERSION=16.0.0 \
		FZF_NATIVE_FUZZ_SEED=$(FZF_NATIVE_FUZZ_SEED) \
		FZF_NATIVE_UPSTREAM_CASES=$(FZF_NATIVE_UPSTREAM_CASES) \
		FZF_NATIVE_UPSTREAM_START=$(FZF_NATIVE_UPSTREAM_START) \
		FZF_NATIVE_UPSTREAM_PROFILE=$(FZF_NATIVE_UPSTREAM_PROFILE) \
