...
the pinned Go tables.  It accepts exactly 28 version differences: U+A7CE,
U+A7D2, U+A7D4, and U+16EA0--U+16EB8.  Any other difference, or any change to
that set, fails the audit.
