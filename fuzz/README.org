...
Raw algorithms use the pinned fzf Latin-fold table and support both search
directions.
The Emacs API does not expose normalization or backward search yet.
Scoring, ranking, and those API gaps are parity debt.
