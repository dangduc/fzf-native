...
The parsed lane accepts only malformed UTF-8 decoder behavior.
...
U+16EA0--U+16EB8; utf8proc's Unicode 16 tables do not.  The exhaustive audit
checks all 1,488 Go lowercase pairs and accepts exactly those 28 misses.  A
toolchain, table, result-shape, or exception-count change fails the audit and
requires an explicit pin review.
...
The strict parity profile compares supported ranking behavior without an exception.
